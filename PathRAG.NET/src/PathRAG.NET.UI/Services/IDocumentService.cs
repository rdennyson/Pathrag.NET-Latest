...
public interface IDocumentService
{
    ...
    Task<DocumentUploadResponse> UploadDocumentAsync(Stream fileStream, string fileName, string contentType);
...
public class DocumentService : IDocumentService
{
    ...
    public async Task<DocumentUploadResponse> UploadDocumentAsync(Stream fileStream, string fileName, string contentType)
    {
